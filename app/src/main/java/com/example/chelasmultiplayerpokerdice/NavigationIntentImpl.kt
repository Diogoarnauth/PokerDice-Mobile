...
class NavigationIntentImpl(private val context: Context) : TitleNavigation, AboutNavigation,
    PlayerProfileNavigation, LobbiesNavigation, LobbyNavigation, LobbyCreationNavigation {
